...
module.exports = {
  ...
  "Changelog": {
    ...
    content: [
      ...
      { type: 'bulleted_list_item', bulleted_list_item: { rich_text: [{ type: 'text', text: { content: 'v1.3.2: Complete GitHub secrets setup for both repositories with automated Notion sync.' } }] } },
  ...
  "Deployment Guide": {
    ...
    content: [
      ...
      { type: 'heading_2', heading_2: { rich_text: [{ type: 'text', text: { content: 'GitHub Secrets Setup' } }] } },
      { type: 'paragraph', paragraph: { rich_text: [{ type: 'text', text: { content: 'All API keys and tokens are securely stored in GitHub secrets for both repositories (GameDinDiscord and GameDin).' } }] } },
      { type: 'bulleted_list_item', bulleted_list_item: { rich_text: [{ type: 'text', text: { content: 'DISCORD_TOKEN, DISCORD_CLIENT_ID, DISCORD_GUILD_ID' } }] } },
      { type: 'bulleted_list_item', bulleted_list_item: { rich_text: [{ type: 'text', text: { content: 'NOTION_API_KEY, MISTRAL_API_KEY' } }] } },
      { type: 'heading_2', heading_2: { rich_text: [{ type: 'text', text: { content: 'Automated Notion Sync' } }] } },
      { type: 'paragraph', paragraph: { rich_text: [{ type: 'text', text: { content: 'GitHub Actions automatically syncs documentation to Notion when changes are pushed to docs/ or scripts/notion-*.js files.' } }] } },
      { type: 'bulleted_list_item', bulleted_list_item: { rich_text: [{ type: 'text', text: { content: 'Manual trigger available from Actions tab' } }] } },
      { type: 'bulleted_list_item', bulleted_list_item: { rich_text: [{ type: 'text', text: { content: 'Supports auto, manual, and full sync modes' } }] } },
  ...
  "Support & Troubleshooting": {
    ...
    content: [
      ...
      { type: 'heading_2', heading_2: { rich_text: [{ type: 'text', text: { content: 'GitHub Actions Issues' } }] } },
      { type: 'bulleted_list_item', bulleted_list_item: { rich_text: [{ type: 'text', text: { content: 'Workflow failures: Check GitHub secrets are properly configured.' } }] } },
      { type: 'bulleted_list_item', bulleted_list_item: { rich_text: [{ type: 'text', text: { content: 'Notion sync issues: Verify API key and page permissions.' } }] } },
